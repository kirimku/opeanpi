...
### Warranty Management (Multi-Tenant)
- ✅ **Storefront-prefixed warranty endpoints** for multi-tenant support
- ✅ Warranty registration within storefront context
- ✅ Warranty validation and activation per storefront
- ✅ Customer warranty claims management
- ✅ Warranty notifications and status updates
- ⚠️ **Legacy customer endpoints deprecated** - use storefront-prefixed endpoints
...
**Important:** Legacy customer warranty endpoints have been removed. All applications must use the new storefront-prefixed endpoints:

#### Removed Endpoints → Current Endpoints

| Removed Legacy Endpoint | Current Storefront-Prefixed Endpoint |
|------------------------|--------------------------------------|
| `POST /api/v1/customer/warranties` | `POST /api/v1/storefront/{slug}/warranty/customer/warranties/register` (requires authentication) |
| `GET /api/v1/customer/warranties` | `GET /api/v1/storefront/{slug}/warranties` |
| `GET /api/v1/customer/warranties/{id}` | `GET /api/v1/storefront/{slug}/warranties/{id}` |
| `POST /api/v1/customer/warranties/{id}/claims` | `POST /api/v1/storefront/{slug}/warranties/{id}/claims` |
| `GET /api/v1/customer/claims` | `GET /api/v1/storefront/{slug}/claims` |
| `GET /api/v1/customer/claims/{id}` | `GET /api/v1/storefront/{slug}/claims/{id}` |
| `PUT /api/v1/customer/claims/{id}` | `PUT /api/v1/storefront/{slug}/claims/{id}` |
| `POST /api/v1/customer/claims/{id}/cancel` | `POST /api/v1/storefront/{slug}/claims/{id}/cancel` |
| `POST /api/v1/customer/claims/{id}/attachments` | `POST /api/v1/storefront/{slug}/claims/{id}/attachments` |
| `DELETE /api/v1/customer/claims/{claim_id}/attachments/{attachment_id}` | `DELETE /api/v1/storefront/{slug}/claims/{claim_id}/attachments/{attachment_id}` |
| `GET /api/v1/customer/notifications/warranty` | `GET /api/v1/storefront/{slug}/notifications/warranty` |
| `POST /api/v1/customer/notifications/warranty/{id}/read` | `POST /api/v1/storefront/{slug}/notifications/warranty/{id}/read` |
| `POST /api/v1/public/warranty/validate` | `POST /api/v1/storefront/{slug}/warranty/{barcode}/validate` |
| `POST /api/v1/public/warranty/activate` | `POST /api/v1/storefront/{slug}/warranty/{barcode}/activate` |

### Migration Benefits

- **Multi-tenant support**: Each storefront operates independently
- **Better security**: Storefront-scoped access control
- **Improved organization**: Clear separation of storefront data
- **Enhanced scalability**: Better resource isolation

### Migration Status

- **✅ Complete**: Legacy endpoints have been removed
- **✅ Active**: Only storefront-prefixed endpoints are available
